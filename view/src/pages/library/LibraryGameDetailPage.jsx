...
const CodeDetailPage = () => {
  ...
  const handleNavigateBack = () => {
    ...
    localStorage.setItem("libraryState", JSON.stringify(libraryCodes));
    navigate("/library-code");
  };
        ...
        <CodeDetailContainer>
          <CodeHeader>
            ...
            <Buttons>
              ...
              <BackButton onClick={handleNavigateBack}>Back to Library</BackButton>
            </Buttons>
          </CodeHeader>
          ...
          <CodeBlock>
            <SyntaxHighlighter
              language={activeLanguage.toLowerCase() === "cpp" ? "cpp" : activeLanguage.toLowerCase()}
